...
import Q1Thumbnail from "../images/QuizThumbnails/Q1Thumbnail.jpg";
import Q2Thumbnail from "../images/QuizThumbnails/Q2Thumbnail.jpg";
      ...
      <Grid container className={classes.topDiv}>
        ...
        <Grid className={classes.quizContainer}>
          <Link to="/quiz1" className={classes.link}>
            <QuizPicture image={Q1Thumbnail} text="Colours Quiz" />
          </Link>
          <Link to="/quiz2" className={classes.link}>
            <QuizPicture image={Q2Thumbnail} text="Baking a Cookie" />
          </Link>
